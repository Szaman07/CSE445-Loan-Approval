...
export default function Simulator({ modelReady }: { modelReady: boolean }) {
  ...
  return <div className="page-stack"><section className="page-intro simulator-intro"><div><span className="kicker">Baseline → scenario</span><h1>Compare two applicant profiles</h1><p>Edit the example values and compare the new model score with the original profile. The score is not a probability.</p></div><button className="secondary" onClick={reset}><RefreshCw size={16} /> Reset both</button></section>
